...
const MEMORY_SNIPPETS = [
  { type: 'text', content: 'Teaching me how to ride a bike...' },
  { type: 'text', content: 'Always making sure we had the best...' },
  { type: 'voice', content: '🎵 "I am so proud of you..."' },
  { type: 'text', content: 'Late night study snacks...' }
];
    ...
    >
      ...
      <div className="absolute inset-0 z-30 pointer-events-none">
        {revealedConstellations.map((constellation, i) => {
          ...
          const letterSpacing = 8; // % width per letter
        ...
        <motion.div
          ...
          className="absolute top-1/2 left-1/2 transform translate-x-[25vw] -translate-y-[20%] text-5xl md:text-7xl drop-shadow-[0_0_30px_rgba(255,0,0,0.8)]"
